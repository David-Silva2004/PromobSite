...
import { ChevronRight, FileCode2, MapPin, Palette, Truck } from "lucide-react";
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          src={`../../../Public/images/backgroundhero.png`}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Mais precisão, organização e <span className="text-accent text-blue-500">valor</span> para seus projetos.
          </motion.h1>
          ...
          >
            <Button
              size="lg"
              className="w-full sm:w-auto bg-blue-600 text-white hover:bg-blue-700 h-14 px-8 rounded-full text-lg font-bold shadow-lg shadow-blue-600/20"
